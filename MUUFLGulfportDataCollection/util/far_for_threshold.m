function far = far_for_threshold(th,hsi,det_img,filt,params)
% far = far_for_threshold(th,hsi,det_img,filt,params)
%
%  finds the false alarm rate for a given threshold in the detector output image (det_img)
%
% 5/7/2013 - Taylor Glenn - tcg@cise.ufl.edu 
